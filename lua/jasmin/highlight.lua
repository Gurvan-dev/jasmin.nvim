...
local hl = {
  ...
  Search       = { bold = true,
                   fg = c.regular.white,          bg = c.bright.black,
              ctermfg = cterm.regular.white, ctermbg = cterm.bright.black },
  CurSearch    = { bg = c.regular.black,     ctermbg = cterm.bright.blue },
  ...
  NvimTreeSymlink      = { fg = c.regular.yellow, ctermfg = cterm.regular.yellow   },
